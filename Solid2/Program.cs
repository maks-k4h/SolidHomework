...
// порушено SRP — надсилач повідомлень також виконує логування
// порушено OCP — зміна логіки логування веде до зміни класу EmailSender;
//                логування варто зробити розширенням, а не модифікацією.
// LSP не порушено — відсутня ієрархія
// ISP не порушено — відсутні інтерфейси
// DIP не порушено — відсутні деталі, хоча клас Email потенційно може стати інтерфейсом.  
